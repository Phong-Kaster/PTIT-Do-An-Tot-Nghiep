...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light">
      ...
      <!-- CONTENT -->
      <?php require_once(APPPATH.'/views/fragments/personalUpdate.fragment.php'); ?>
      <!-- end CONTENT -->
    ...
    <script src="<?= APPURL."/assets/js/customized/personalUpdate.js?v=".VERSION ?>"></script>
    <script>
        CKEDITOR.replace( 'description' );
        let id = <?= $AuthUser->get("id")  ?>;
        setupButton();
    </script>
  </body>
</html>