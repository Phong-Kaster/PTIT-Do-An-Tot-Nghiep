...
<html lang="en">
  ...
  <base href="./">
    ...
    <link href="<?= APPURL."/assets/css/lightbox.css?v=".VERSION ?>" rel="stylesheet">
    <link href="<?= APPURL."/assets/css/lightbox.min.css?v=".VERSION ?>" rel="stylesheet">
    <style>
      .example-image 
      {
          width: 7rem;
  ...
  <body>
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light">
      ...
      <!-- CONTENT -->
      <?php require_once(APPPATH.'/views/fragments/bookingPhotos.fragment.php'); ?>
      <!-- end CONTENT -->
    ...
    <!-- LIGHT BOX -->
    <script src="<?= APPURL."/assets/js/lightbox.js?v=".VERSION ?>"></script>
    <script>
        lightbox.option({
          'resizeDuration': 200,
          'wrapAround': true
        })
    </script><!-- end LIGHT BOX -->

    <script src="<?= APPURL."/assets/js/customized/bookingPhotos.js?v=".VERSION ?>"></script>
    <script>
        let id = <?= $id  ?>;
        getBookingPhotos(id);
    </script>
