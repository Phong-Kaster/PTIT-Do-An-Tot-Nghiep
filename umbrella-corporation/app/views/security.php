...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-light">
      ...
      <!-- CONTENT -->
      <?php require_once(APPPATH.'/views/fragments/security.fragment.php'); ?>
      <!-- end CONTENT -->
    ...
    <script src="<?= APPURL."/assets/js/customized/security.js?v=".VERSION ?>"></script>
    <script>
        let email = "<?= $AuthUser->get("email"); ?>";
        setupButton(email);
    </script>
  </body>
</html>